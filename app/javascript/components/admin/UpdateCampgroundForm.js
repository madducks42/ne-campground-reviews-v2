...
const UpdateCampgroundForm = (props) => {
  ...
  const validForSubmission = () => {
    let submitErrors = {};
    const requiredFields = ["name", "caption", "caption", "location"];
              ...
              <label className="label">
                ...
                <div className="control">
                  <textarea
                    ...
                    type="textarea"
                    onChange={handleChange}
                    value={updatedCampground.review}
                    className="campground-form"
                  />
                </div>
              </label>
              ...
              <label className="label">
                ...
                <div className="control">
                  <input
                    ...
                    type="text"
                    onChange={handleChange}
                    value={updatedCampground.image_name}
                    className="campground-form"
                  />
                </div>
              </label>
              ...
              <label className="label">
                ...
                <div className="control">
                  <input
                    ...
                    type="text"
                    onChange={handleChange}
                    value={updatedCampground.image_num}
                    className="campground-form"
                  />
                </div>
              </label>
