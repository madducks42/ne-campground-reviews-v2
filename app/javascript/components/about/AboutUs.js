      ...
      <div className="container">
        <div className="flex-column callout mt-6">
          ...
          <p className="is-size-7">
            ...
            dozens of other projects piling up that we should be working
            on.&quot; It took us less than five minutes to grab our laptops and
            get to work.
          </p>
          <p className="is-size-7">
            So that&apos;s how this website came to be. Every time we visit a
            new campground we&apos;ll add it here as well as add updates to our
            favorite campgrounds. The camper modifications will never be done.
            Neither of us are capable of not continuing to find ways to improve
            it because neither of us know how to relax and do nothing.
          </p>
          <p className="is-size-7">
            If you&apos;re interested in following our adventures on social
            media check out the links below for Perpetually Lost Photography. In
            addition to camping around New England we normally take several
            trips a year to various national parks and try to visit Costa Rica
            as often as we can.
          </p>
          <br />
